...
- 来源：手工整理自各公司2026年最新一次财报电话会/官方新闻稿，经WebSearch核对多篇财经媒体
  （CNBC、CFO Dive、Intellectia、mlq.ai等）转述，另附少量第三方分析师估计（Citi、UBS、
  SemiAnalysis及一份综合一致预期，来源方法论不透明）
- 访问日期：2026-08-16（回应用户"是否能找到五大厂商资本开支的未来预期/预测数据"的提问）
- 覆盖：MSFT/AMZN/GOOGL/META/ORCL，2025实际值 + 2026/2027(部分含2028)前瞻数据
- **真实亮点数字**：GOOGL 2026年指引在年内已三次上修（年初175-185B→4月180-190B→7月
  195-205B）；ORCL FY2027官方指引gross口径90-95B，较FY2026实际55.7B增长约65%；
  META 2027一致预期185.6B，若成立将超过除AMZN外其余三家2026年指引
- **数据完整度差异（未强行拉齐）**：MSFT/ORCL用财年、AMZN/GOOGL/META用自然年，五家
  时间轴不可直接对齐比较；GOOGL/META的2027年只有第三方分析师估计、无官方数字，且
  GOOGL两个分析师估计(250B/308B)相差近25%；AMZN 2027/2028、MSFT/GOOGL/META/ORCL
  的2028年，官方均未给具体数字（仅ORCL/MSFT有"还会增长"的定性表态），图上和CSV里
  都标注为无数据，未编造
